...
gulp.task(`dev`, gulp.series(`del`, gulp.parallel(`fonts`, `pug`, `img`, `svg-sprite`, `css`, `js`), gulp.parallel(`watch`, `serve`)));
gulp.task(`build`, gulp.series(`del`, gulp.parallel(`fonts`, `pug:prod`, `img:prod`, `svg-sprite`, `css:prod`, `js:prod`), gulp.parallel(`watch`, `serve`)));
